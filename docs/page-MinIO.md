...
client.fput_object(
    ...
    content_type="image/jpeg" # اختیاری
)
```

برای مشاهده نتیجه عملیات بارگذاری فایل به داشبورد مدیریت مراجعه کنید، از بخش **Object Browser** وارد باکت ایجاد شده شوید.

![](img/MinIO/img/15-0.png)

پس از وارد شدن به باکت فایل بارگذاری شده قابل مشاهده است.
